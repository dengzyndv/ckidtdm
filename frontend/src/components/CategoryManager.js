...
const CategoryManager = () => {
  ...
  const fetchCategories = async () => {
    ...
    setError(null);
    try {
      // Sửa endpoint từ /categories thành /api/categories
  ...
  const handleAddCategory = async (e) => {
    ...
    try {
      // Sửa endpoint từ /categories thành /api/categories
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/categories`, { name: newCategory });
  ...
  const handleEditCategory = async () => {
    ...
    try {
      // Sửa endpoint từ /categories thành /api/categories
      const response = await axios.put(`${process.env.REACT_APP_API_URL}/api/categories/${editCategory.id}`, {
  ...
  const handleDeleteCategory = async () => {
    ...
    try {
      // Sửa endpoint từ /categories thành /api/categories
      const response = await axios.delete(`${process.env.REACT_APP_API_URL}/api/categories/${deleteCategory.id}`);
      alert(response.data.message);
